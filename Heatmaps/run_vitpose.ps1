...
$RUN_DIR = 'C:\Storage\GeneratedFiles\ViTPose'
$PRETRAINED_CHECKPOINT = 'C:\path\to\vitpose-b.pth' # Standard COCO 256x192 ViTPose-B pose checkpoint.
...
$RUN_NAME = "vitpose_of$($OVERSAMPLING_FACTOR)_bs$($BATCH_SIZE)_lr$($LEARNING_RATE)_size$($IMAGE_SIZE)_plateau$($DECODER_PLATEAU_PATIENCE)_blocks$($FINETUNE_LAST_BLOCKS)_$($LR_SCHEDULE)"
